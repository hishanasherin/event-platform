...
SAMPLE_EVENTS = [
    ...
    },
    {
        ...
        "location": "Innovation Park, Hyderabad",
        "days_from_now": 21,
    },
    {
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        if Event.objects.exists():
            self.stdout.write(self.style.WARNING('Events already exist. Skipping seed.'))
            return
